...
Speaking of credentials, we need to get those to create our stream.

Click the Manage link in the service to obtain the credentials for the service. This will give the HostName, Username and Password.
